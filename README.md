...
## 기능
이 사내 채팅 애플리케이션은 Kafka를 사용한 실시간 메시징 기능과 curses 기반의 터미널 인터페이스를 제공합니다. 아래는 주요 기능에 대한 설명입니다:
...
유연한 검색: 공백이 포함된 제목을 처리할 수 있으며, 입력된 제목과 사전에 저장된 제목 간의 공백을 제거하여 비교합니다. 이를 통해 사용자는 영화 제목을 다양한 방식으로 입력할 수 있습니다.
